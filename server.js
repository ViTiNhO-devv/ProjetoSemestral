...
app.get('/beneficios', (req, res) => res.sendFile(__dirname + '/public/beneficios.html'));
app.get('/quem-somos', (req, res) => res.sendFile(__dirname + '/public/quem-somos.html'));
app.get('/contato', (req, res) => res.sendFile(__dirname + '/public/contato.html'));
app.get('/politica-de-privacidade', (req, res) => res.sendFile(__dirname + '/public/politica-de-privacidade.html'));
app.get('/termos-de-uso', (req, res) => res.sendFile(__dirname + '/public/termos-de-uso.html'));
app.get('/faqs', (req, res) => res.sendFile(__dirname + '/public/faqs.html'));
app.get('/obrigado', (req, res) => res.sendFile(__dirname + '/public/obrigado.html'));
